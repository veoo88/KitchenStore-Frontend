            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
              {deals.map(d => (
                <tr key={d.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                  ...
                  <td className="px-4 py-3 text-gray-400 line-through text-xs">{formatPrice(d.product?.price / (1 - d.discountPercent / 100))}</td>
                  <td className="px-4 py-3"><span className="bg-red-100 text-red-600 px-2 py-0.5 rounded-full text-xs font-black">-{d.discountPercent}%</span></td>
                  <td className="px-4 py-3 font-black text-yellow-600 dark:text-yellow-400">{formatPrice(d.product?.price)}</td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <button onClick={() => openEdit(d)} className="p-1.5 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100"><i className="bx bx-pencil"></i></button>
                      <button onClick={() => setDeleteTarget(d.id)} className="p-1.5 rounded-lg bg-red-50 text-red-500 hover:bg-red-100"><i className="bx bx-trash"></i></button>
                    </div>
                  </td>
                </tr>
              ))}
